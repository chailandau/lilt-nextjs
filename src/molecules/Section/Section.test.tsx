...
describe('Section', () => {
    it('defaults to section tag', () => {
        ...
        expect(screen.getByText('This text is in a section').closest('section')).toBeDefined();
    });
    it('applies correct class', () => {
        render(<Section />);
        expect(screen.getByText('This text is in a section').closest('section')).toHaveClass('section');
    });
    testAxeViolations(<Section />);
    testMatchesSnapshot(<Section />);
});
